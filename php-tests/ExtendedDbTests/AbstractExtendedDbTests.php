...
abstract class AbstractExtendedDbTests extends CommonTestClass
{
    ...
    {
        return 'DROP TABLE IF EXISTS `test_taxonomy_2`;';
    }

    protected function basicTable() : string
    {
        return "CREATE TABLE IF NOT EXISTS `test_taxonomy_2` (
...
";
    ...
    {
        return "INSERT IGNORE INTO `test_taxonomy_2` (`tid`, `parent_id`, `t_type`, `t_name`, `t_status`, `t_position`, `t_level`, `t_left`, `t_right`) VALUES
