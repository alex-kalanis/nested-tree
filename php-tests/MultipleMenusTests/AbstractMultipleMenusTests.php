...
abstract class AbstractMultipleMenusTests extends CommonTestClass
{
    use DumpTrait;
    ...
    protected function rebuild(int $menuId = 0) : void
    {
        ...
        $optionsWhere->bindValues = [':menu_id' => $menuId];
...
";
    ...
    {
        return 'INSERT IGNORE INTO `test_taxonomy_3` (`id`, `parent_id`, `menu_id`, `deleted`, `order`) VALUES
(1, null, 1, 0, 1),
(2, null, 1, 0, 2),
(3, null, 1, 0, 3),
(4, 2, 1, 0, 1),
